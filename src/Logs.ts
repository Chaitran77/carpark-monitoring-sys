...
abstract class Logs {
    ...
    public static async createRecordNoEntry(numberplate:string, image:string, knownVehicle: boolean, camera_id: number, timestamp:string) {
        ...
        const secondsString = Logs.timestampStringToSeconds(timestamp).toString();
		await dbQuery.makeDBQuery(`INSERT INTO "Log" (numberplate, entry_timestamp, entry_image_base64, exit_timestamp, known_vehicle, camera_id, acknowleged) VALUES ($1, to_timestamp($2), $3, to_timestamp($4), $5, $6, false);`,
