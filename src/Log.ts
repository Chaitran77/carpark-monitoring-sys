class Log {
	...
	constructor(EventID: number, CameraID: number, VehicleID: number, Numberplate: string, EntryTimestamp: Date, ExitTimestamp: Date, EntryImageBase64: string, ExitImageBase64: string, KnownVehicle: boolean) {
